...
function page() {
  ...
  const form = useForm<z.infer<typeof signUpSchema>>({ //z.infer chudap hai, optional
  ...
  useEffect(()=>{
    const checkUserNameUniqeness = async()=>{
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  usernameMessage === "Username is unique" ? (
                    ...
                    <p className="text-sm text-red-500">{usernameMessage}</p>
                  )}
                  <FormMessage />
                </FormItem>
              )}
